...
public class Employees extends JFrame implements ActionListener {
   ...
   private String[] columns ={"First name","Last name","Employee ID","Salary"};
   ...
   public void initComponents(){
       ...
       titleLabel = new JLabel("Employees information");
      ...
      addButton.setBounds(400,80,100,30);
       ...
       phoneLabel = new JLabel("employee ID  ");
           ...
           int numberOfRow = table.getSelectedRow();
            ...
            if(numberOfRow>=0){
               model.removeRow(numberOfRow);
                ...
                JOptionPane.showMessageDialog(null, "No Rows Has Been Selected");
